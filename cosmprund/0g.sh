...
PARENT_DIR="/home/ubuntu/.0gchain"
DATA_PATH="${PARENT_DIR}/data/"
SNAPSHOT_DIR="${DATA_PATH}snapshots"
SERVICE_NAME="0gd.service"
RPC_ADDRESS="http://localhost:26657"
CLI_COMMAND="0gchaind"
CATCHING_UP=$(curl -s ${RPC_ADDRESS}/status | jq -r .result.sync_info.catching_up)

LOG_PATH="/home/ubuntu/snapshots/logs/cosmprund/0g_log.txt"
...
if [[ "$CATCHING_UP" == "false" ]]; then
    ...
    PRUNE_OUTPUT=$(sudo docker run -v ${DATA_PATH}:${DATA_PATH} cosmprund prune --cosmos-sdk=false ${DATA_PATH} 2>&1)
